...
def test_mcp_description_stored_in_view_introspectable():
    ...
    config.add_view(view_with_desc, route_name='with_desc', 
                    mcp_description='Custom description')
...
def test_pyramid_introspector_extracts_mcp_description():
    ...
    config.add_view(test_view, route_name='test_route', 
                    mcp_description='Route description')
    config.commit()
...
def test_mcp_description_used_in_tool_generation():
    ...
    config.add_view(api_view, route_name='api_endpoint', renderer='json', 
    ...
    assert api_tool.description and 'API endpoint for testing MCP description feature' in api_tool.description
...
def test_mcp_description_priority_over_docstring():
    ...
    config.add_view(view_with_both, route_name='priority_test', 
...
def test_multiple_views_with_different_descriptions():
    ...
    config.add_view(list_users, route_name='users_list', 
                    request_method='GET', mcp_description='List all users')
    config.add_view(create_user, route_name='users_list', 
                    request_method='POST', mcp_description='Create a new user')
    config.commit()
