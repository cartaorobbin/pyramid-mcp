...
def setup_mcp_tools(pyramid_mcp):
    ...
    @pyramid_mcp.tool(name="admin_tool", description="Admin MCP tool", permission="admin")
...
def test_context_factory_security_works_for_regular_views(context_factory_config, mock_security_policy):
    ...
    config.add_view(public_view, route_name='public_endpoint', renderer='json', permission='view')
    config.add_view(auth_view, route_name='auth_endpoint', renderer='json', permission='view')
    config.add_view(admin_view, route_name='admin_endpoint', renderer='json', permission='admin')
...
def test_mcp_tools_ignore_context_factory_security_BUG(context_factory_config, mock_security_policy):
    """
...
def test_mcp_tools_only_check_permission_parameter_not_context_acl(context_factory_config, mock_security_policy):
    """
...
def test_mcp_context_factory_integration_FIXED(context_factory_config, mock_security_policy):
    """
    ...
    @pyramid_mcp.tool(name="secure_context_tool", description="Tool with context factory security", permission="view")
    ...
    assert 'result' in response.json, "Fix should allow authenticated users through context factory ACL"
...
def test_mcp_tools_metadata_missing_security_info(context_factory_config, mock_security_policy):
