"""
Unit tests for pyramid_mcp authentication parameter functionality.

This module tests:
- Authentication credential extraction from tool arguments
- HTTP header generation from credentials
- Parameter removal from tool arguments
