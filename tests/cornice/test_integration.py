...
def test_marshmallow_field_to_mcp_type():
    ...
    for field_obj, expected_type in test_fields.items():
        ...
        assert result == expected_type, f"Field {field_obj} should map to {expected_type}, got {result}"
...
def test_cornice_service_with_marshmallow_schema(pyramid_app_with_services, products_service):
...
def test_cornice_service_with_schema_via_mcp(pyramid_app_with_services, products_service):
...
def test_cornice_service_tool_info_validation(pyramid_app_with_services, products_service, users_service):
