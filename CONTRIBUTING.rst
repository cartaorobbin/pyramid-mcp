...
Report bugs at https://github.com/tomas_correa/pyramid-mcp/issues
...
https://github.com/tomas_correa/pyramid-mcp/issues.
...
Ready to contribute? Here's how to set up `pyramid-mcp` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `pyramid-mcp` repo on GitHub. 
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/pyramid-mcp.git
