...
@users_service.get()  # type: ignore[misc]
...
@users_service.post(
    schema=CreateUserSchema, validators=(marshmallow_body_validator,)
)  # type: ignore[misc]
...
@posts_service.get()  # type: ignore[misc]
...
@posts_service.post(
    schema=CreatePostSchema, validators=(marshmallow_body_validator,)
)  # type: ignore[misc]
...
@admin_service.post(
    schema=AdminActionSchema, validators=(marshmallow_body_validator,)
)  # type: ignore[misc]
